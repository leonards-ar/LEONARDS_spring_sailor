...
<body bgcolor="#FFFFFF" text="#000000">
              ...
              <input type="hidden" name="webaction" value="SAVE_USER_PASSWORD">     
...
<!-- User Table -->
            ...
            <table class="inner_table">
						...
						<tr>
							...
							<td align="left"><div class="value"><%=WebFrameworkToolkit.getHtmlString(userToEdit.getName())%>&nbsp;<%=WebFrameworkToolkit.getHtmlString(userToEdit.getSurname())%></div></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									<td align="center" width="50%"><input type="submit" value="Cancelar" name="formCancelar" id="formCancelar" onClick="return doSubmit('CANCEL_UPDATE_USER_PASSWORD');"></td>
									<td align="center" width="50%"><input type="submit" value="Guardar" name="formSubmit" id="formSubmit" onClick="return doSubmit('SAVE_USER_PASSWORD');"></td>
								</tr>
							</table>
							</td>
						</tr>
