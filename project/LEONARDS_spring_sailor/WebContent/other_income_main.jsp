...
<body bgcolor="#FFFFFF" text="#000000">
              ...
              <input type="hidden" name="successPage" value="other_income_main.jsp">
              <input type="hidden" name="validationErrorPage" value="other_income_main.jsp">
...
<!-- Movement Table -->
            ...
            <table class="inner_table">
						<tr>
							<td colspan="2" align="center" class="title3_bg"><div class="title3_txt">Otros Ingresos</div></td>
						</tr>
						<tr>
						...
						<tr>
							<td align="right"><div class="label">(*) movimiento:</div></td>
							<td align="left">
								<select name="movementTypeId" id="movementTypeId">
								<%
									java.util.Iterator types = leonards.spring.domain.StaticDataManager.getOtherIncomeMovementTypes().iterator();
									leonards.spring.domain.MovementType aType;
									while( types != null && types.hasNext() ) {
										aType = (leonards.spring.domain.MovementType)types.next();
								%>
									<option value="<%=aType.getIdAsInteger()%>" <%=(aType.getIdAsInteger().equals(movementToEdit.getMovementTypeId()) ? "selected" : "")%>><%=aType.getDescription()%></option>
								<%
									}
								%>
								</select>							
