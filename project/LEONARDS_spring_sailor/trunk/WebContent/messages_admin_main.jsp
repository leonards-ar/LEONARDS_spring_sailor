...
<!-- Search Results Table -->
            ...
            <table class="inner_table">
				...
				<tr>
					<td align="center">
					<!-- Paging Table -->
					<form action="<%= leonards.common.web.framework.WebFrameworkToolkit.getDocumentUrl("messages_admin_main.jsp")%>" method="post" name="pagingForm" id="pagingForm">
					...
					<!-- Results Table -->
						...
						<input type="hidden" name="successPage" value="messages_admin_main.jsp">
						...
						<table>
							...
							<tr>
								...
								<td align="right" class="even_results_table_row"><div class="label"><a onClick="return confirm('Confirma que elimina el mensaje del usuario <%=WebFrameworkToolkit.getJSString(aMsg.getUser().getCompleteName())%>?');" href="javascript:submitActionForm('DELETE_MESSAGE','<%=i%>', true)">Borrar</a></div></td>
							</tr>
							<tr>
								<td class="odd_results_table_row" colspan="3">
