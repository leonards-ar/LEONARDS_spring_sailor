...
<body bgcolor="#FFFFFF" text="#000000">
              ...
              <input type="hidden" name="successPage" value="expense_main.jsp">
              <input type="hidden" name="validationErrorPage" value="expense_main.jsp">
...
<!-- Movement Table -->
            ...
            <table class="inner_table">
						<tr>
							<td colspan="2" align="center" class="title3_bg"><div class="title3_txt">Egresos</div></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="left">
								...
								<%
									java.util.Iterator types = leonards.spring.domain.StaticDataManager.getExpenseMovementTypes().iterator();
