 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ReservationDetailsActionCommand extends SpringActionCommand {

	/**
	 * 
	 */
	public ReservationDetailsActionCommand() {
		super();
	}
	...
	public void execute() throws WebActionException {
		try {
			removeFromSession("newReservation");
			putInSession("reservation", getTimeTableShift().getReservation());
		} catch( Throwable ex ) {
