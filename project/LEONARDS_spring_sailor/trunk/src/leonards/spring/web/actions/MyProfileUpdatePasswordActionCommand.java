 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class MyProfileUpdatePasswordActionCommand extends SpringActionCommand {

	/**
	 * 
	 */
	public MyProfileUpdatePasswordActionCommand() {
		super();
	}
	...
	public void execute() throws WebActionException {
		try {
			...
			if( userToEdit == null ) {
				userToEdit = (User)((User)getFromSession("user")).clone();
