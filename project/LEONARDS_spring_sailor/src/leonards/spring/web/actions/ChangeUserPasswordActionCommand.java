 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ChangeUserPasswordActionCommand extends SpringActionCommand {
	...
	public void execute() throws WebActionException {
		try {
			User userToEdit = (User)((Vector)getFromSession("users")).elementAt(getIntegerParameter("userIndex").intValue());
