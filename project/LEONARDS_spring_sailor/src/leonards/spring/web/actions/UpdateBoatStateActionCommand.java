 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class UpdateBoatStateActionCommand extends SpringActionCommand {
	...
	public void execute() throws WebActionException {
		try {
			Boat boatToEdit = (Boat)((Boat)((Vector)getFromSession("boats")).elementAt(getIntegerParameter("boatIndex").intValue())).clone();
			putInSession("boatToEdit", boatToEdit);
		} catch( Throwable ex ) {
